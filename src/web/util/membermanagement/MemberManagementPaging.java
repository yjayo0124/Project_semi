package web.util.membermanagement;

public class MemberManagementPaging {
		...
		//	pageCount == 10
		//	listCount == 10
		public MemberManagementPaging(int totalCount) {
		...
		//	pageCount == 10
		//	listCount == 10
		public MemberManagementPaging(int totalCount, int curPage) {
			this.setTotalCount(totalCount);
		...
		// �� �Խñ� ���� ���� ������, �������� �Խñ� ���� �Է��ϴ� ������
		//	pageCount == 10
		public MemberManagementPaging(int totalCount, int curPage, int listCount) {
			this.setTotalCount(totalCount);
			this.setCurPage(curPage);
		...
		// �� �Խñ� ���� ���� ������, �������� �Խñ� ��, ������ ���� �Է��ϴ� ������
		public MemberManagementPaging(int totalCount, int curPage, int listCount, int pageCount) {
			this.setTotalCount(totalCount);
			this.setCurPage(curPage);
			this.setListCount(listCount);
