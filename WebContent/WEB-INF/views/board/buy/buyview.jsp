...
<span class="glyphicon glyphicon-menu-up"><a href="/buy/view?boardno=${prev_next.prev}">	
...
<span class="glyphicon glyphicon-menu-down">	<a href="/buy/view?boardno=${prev_next.next }">
